...
<body>
            ...
            <div class="search">
              <form action="{{ url('jabatan') }}" method="GET">
                  <div class="form-input">
                      <input type="search" name="katakunci" placeholder="Cari nama atau id..." value="{{ request('katakunci') }}">
		...
		<!--  MAIN  -->
          ...
          <div class="container">
            <div class="card rounded-0">
                <div class="card-header text-white rounded-0"><b>Tambah Jabatan</b></div>
                <div class="card-body">
                  {{-- ngambil dari eksternal dir alert file alert.blade.php --}}
                    ...
                    <form action="{{ url('jabatan') }}" method="post">
                        @csrf
                        <div class="mb-3 row">
                            <label for="jabatanname" class="col-sm-2 col-form-label">Nama Jabatan</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control rounded-0" name="jabatan" id="inputjabatanname" placeholder="input nama jabatan">
                            </div>
                        </div>
            ...
            <div class="container">
              <div class="card rounded-0">
                  <div class="card-header text-white bg-dark rounded-0"><b>Data Jabatan</b></div>
                  <div class="card-body">
                              ...
                              @if ($data->count())
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->jabatan }}</td>
                                            <td>
                                                <a href="#" class="edit" data-id="{{ $item->id_jabatan }}" data-name="{{ $item->jabatan }}" data-bs-toggle="modal" data-bs-target="#editEmployeeModal">
                                                    <i class="bx bxs-edit" data-bs-toggle="tooltip" title="edit"></i>
                                                </a>
                                                <a href="#" class="delete" data-id="{{ $item->id_jabatan }}" data-bs-toggle="modal" data-bs-target="#deleteEmployeeModal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form id="editForm" action="" method="POST">
                            ...
                            <input type="hidden" name="id" id="hiddenJabatanId">
                            {{-- <div class="form-group">
                              <label for="jabatanIdInput">Id Kategori:</label>
                              <input type="text" class="form-control" id="jabatanIdInput" name="jabatanId" value="" readonly>
                            </div> --}}
                            <div class="form-group mt-3">
                              <label for="jabatanName">Nama Kategori:</label>
                              <input type="text" class="form-control" id="jabatanName" name="jabatan" value="">
                            </div>
    ...
    $('.edit').on('click', function() {
      ...
      $('#hiddenJabatanId').val(id);
      $('#jabatanIdInput').val(id);
      $('#jabatanName').val(name);

      var formAction = "{{ url('jabatan') }}/" + id;
